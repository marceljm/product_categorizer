...
CONSOLE = {'xbox one': 0, 'xbox 360': 1, 'ps3': 2, 'ps4': 3, 'psp': 4, 'wii': 5, 'ps2': 6, '3ds': 7, 'vita': 8, 'ds': 9}
...
CUP = {'cerveja': 0, 'agua': 1, 'champanhe': 2, 'vinho': 3, 'sobremesa': 4, 'suco': 5}

DEVICE = {'tablet': 0, 'smartphone': 1, 'notebook': 2, 'pc': 3}
...
GENDER = {'masculino': 0, 'homme': 0, 'men': 0, 'feminino': 1, 'femme': 1, 'woman': 1, 'infantil': 2, 'bebe': 2, 'crianca': 2}
...
MATTRESS = {'casal': 0, 'solteiro': 1, 'queen': 2, 'king': 3, 'infantil': 4}

PET = {'gato': 0, 'cao': 1, 'cachorro': 1, 'passaro': 2, 'ave': 2, 'reptil': 3, 'lagarto': 3, 'hamster': 4, 'roedor': 4}
...
ROOM = {'cozinha': 0, 'jantar': 1, 'escritorio': 2, 'estar': 3, 'sala': 4, 'banheiro': 5, 'lavanderia': 6, 'quarto': 7, 'externa': 8, 'infantil': 9}

VEHICLE = {'moto': 0, 'motocicleta': 0, 'motociclismo': 0, 'carro': 1}
